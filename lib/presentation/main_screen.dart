...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    return CoreScreen(
      child: SafeArea(
        child: Stack(
          children: [
            /// Bagian atas: Appbar + filter + TopCard + Podium
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildCustomDropdown(
                          ...
                          hint: categoryData[0],
                          onTap: () => _showCategorySport(context),
                        ),
                      ),
                      const SizedBox(width: 10),
                      Expanded(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemCount: DummyData.getRankingPlayers().length,
                          itemBuilder: (context, index) {
                            final user = DummyData.getRankingPlayers()[index];
                            final rank = index + 1;
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        Icon(
                                          ...
                                          color: rank == 3 ? ColorAssets.redColor: ColorAssets.greenColor,
                                          size: 16,
                                        ),
                                    ],
                                  ),
  ...
  void _showRegionBottomSheet(BuildContext context) async {
    ...
    if (result != null) {
      print("Region terpilih: $result");
    }
  }

  void _showCategorySport(BuildContext context) async {
    final result = await showModalBottomSheet<String>(
      context: context,
      isScrollControlled: true,
      shape: const RoundedRectangleBorder(
    ...
    if (result != null) {
      print("Category terpilih: $result");
    }
  }
}
